...
DROP POLICY IF EXISTS "Users can view waste tracking in their households" ON waste_tracking;
DROP POLICY IF EXISTS "Users can manage waste tracking in their households" ON waste_tracking;
DROP POLICY IF EXISTS "Anyone can read barcode cache" ON barcode_cache;
DROP POLICY IF EXISTS "Authenticated users can manage barcode cache" ON barcode_cache;
DROP POLICY IF EXISTS "Anyone can read recipes" ON recipes;
DROP POLICY IF EXISTS "Users can view their recipe interactions" ON user_recipe_interactions;
DROP POLICY IF EXISTS "Users can manage their recipe interactions" ON user_recipe_interactions;
DROP POLICY IF EXISTS "Users can view shopping lists in their households" ON shopping_lists;
DROP POLICY IF EXISTS "Users can manage shopping lists in their households" ON shopping_lists;
DROP POLICY IF EXISTS "Users can view shopping list items in their households" ON shopping_list_items;
DROP POLICY IF EXISTS "Users can manage shopping list items in their households" ON shopping_list_items;
DROP POLICY IF EXISTS "Users can view their achievements" ON achievements;
DROP POLICY IF EXISTS "Users can manage their achievements" ON achievements;
...
CREATE POLICY "Users can view waste tracking in their households"
...
CREATE POLICY "Users can manage waste tracking in their households"
...
CREATE POLICY "Authenticated users can manage barcode cache"
...
CREATE POLICY "Users can manage their recipe interactions"
    ON user_recipe_interactions FOR ALL
    USING (auth.uid() = user_id);

-- Create RLS policies for shopping_lists
CREATE POLICY "Users can view shopping lists in their households"
...
CREATE POLICY "Users can manage shopping lists in their households"
...
CREATE POLICY "Users can view shopping list items in their households"
...
CREATE POLICY "Users can manage shopping list items in their households"
...
DROP TRIGGER IF EXISTS set_household_invite_code_trigger ON households;
CREATE TRIGGER set_household_invite_code_trigger
