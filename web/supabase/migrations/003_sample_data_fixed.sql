...
(
    ...
    10, 15, 2, 'easy', 'American', ARRAY[]::text[], 4.3
),
...
(
    ...
    15, 15, 4, 'medium', 'Italian', ARRAY[]::text[], 4.6
),
...
(
    ...
    15, 20, 4, 'easy', 'Mediterranean', ARRAY[]::text[], 4.8
),
...
(
    ...
    15, 30, 6, 'easy', 'American', ARRAY[]::text[], 4.7
),
...
(
    ...
    20, 25, 2, 'medium', 'Korean', ARRAY[]::text[], 4.5
),
...
(
    ...
    15, 20, 4, 'medium', 'Thai', ARRAY[]::text[], 4.7
),
